...
import { View, ImageBackground, Text, StyleSheet, SafeAreaView, ScrollView, TextInput, TouchableOpacity, Image, Dimensions } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  headerTitle: {
    ...
    fontSize: 60,
    color: '#fff',
    marginTop: 40, // Điều chỉnh để chữ ECOMATE nằm đúng vị trí
  },
  formContainer: {
    flex: 1, // Để chiếm phần còn lại của không gian
    alignItems: 'center',
    paddingHorizontal: 33,
    paddingTop: 30,
    paddingBottom: 40,
    backgroundColor: '#fff',
    // Không bo góc cho formContainer, vì đường cong đã được tạo ở headerBackground
  },
  title: {
